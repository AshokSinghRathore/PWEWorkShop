...
const UpdateOrderStatusDryClean = ({ route, navigation }) => {
  const DryCleanOrder = useSelector(state => state.DryCleanOrder.data);
  const [data, setData] = useState(DryCleanOrder.find(item => item.id === route.params));
  ...
  async function updateOrderStatus() {
    ...
    try {
      ...
      if (!data.data().OrderPicked) {
        ...
        Dispatch(updateDryClean(newOrderGet))
...
export default UpdateOrderStatusDryClean;